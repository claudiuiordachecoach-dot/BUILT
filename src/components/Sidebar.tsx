...
const Icons = {
  ...
  wallet:   () => <svg width="15" height="15" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.8" strokeLinecap="round" strokeLinejoin="round"><path d="M3 7a2 2 0 0 1 2-2h13a1 1 0 0 1 1 1v2"/><path d="M3 7v10a2 2 0 0 0 2 2h14a2 2 0 0 0 2-2v-7a1 1 0 0 0-1-1H5a2 2 0 0 1-2-2z"/><circle cx="16.5" cy="13" r="1"/></svg>,
...
const ADMIN_ITEMS: NavEntry[] = [
  ...
  { label: "Încasări",           href: "/dashboard/incasari",         icon: <Icons.wallet /> },
...
export function Sidebar() {
  ...
  // Pe sub-pagini, butonul din stânga deschide meniul (drawer) peste pagina curentă.
  ...
  return (
        ...
        <div className="flex items-center justify-between px-4 h-12">
          <div className="flex items-center gap-2">
            {showBack ? (
              <button
                ...
                className="flex items-center gap-1 -ml-1 pr-2 py-1 rounded-lg text-foreground hover:bg-muted/50 transition-all press"
                aria-label="Deschide meniul"
              >
                <svg width="22" height="22" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
                  <polyline points="15 18 9 12 15 6"/>
                </svg>
                <span className="text-[13px] font-medium">Meniu</span>
              </button>
            ) : (
              <>
          ...
          <div className="flex items-center gap-2">
            ...
            {!showBack && (
              <button
                onClick={() => setMobileOpen(true)}
                className="p-2 rounded-lg text-muted-foreground hover:text-foreground hover:bg-muted/50 transition-all press"
    ...
    <aside
      className={`shrink-0 flex flex-col h-screen bg-background border-r border-border transition-all duration-200
        fixed md:sticky top-0 z-50 mobile-header md:pt-0
