...
export async function sendMessageNotification(clientName: string, message: string) {
  ...
  await transporter.sendMail({
    from: '"BUILT" <claudiuiordache.coach@gmail.com>',
    ...
    html: `
      <div style="font-family: sans-serif; max-width: 480px; margin: 0 auto;">
        <div style="background: #0A0A0A; padding: 24px; border-radius: 8px;">
          <p style="color: #C0392B; font-size: 12px; letter-spacing: 3px; text-transform: uppercase; margin: 0 0 8px;">BUILT — Mesaj Nou</p>
