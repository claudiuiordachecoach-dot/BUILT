...
<div class="panel" id="tab-ziuaA">
  <div class="tag tag-red">Ziua A — Luni · Upper Body 1 (Brațe, Spate, Trapez)</div>
      ...
      <div class="acc-body">
        <div class="ex-list">
          <div class="ex-item">
            ...
            <div>
              <div class="ex-sets">4 × 12-15 repetări</div>
          ...
          <div class="ex-item">
            ...
            <div>
              <div class="ex-sets">4 × 10-12 repetări</div>
              <div class="ex-rest">Rest 60s</div>
            </div>
          </div>
          <div class="ex-item">
          ...
          <div class="ex-item">
            ...
            <div>
              <div class="ex-sets">4 × 15-20 repetări</div>
              <div class="ex-rest">Rest 60s</div>
            </div>
          </div>
        </div>
  ...
  <div class="acc-card orange open">
    <div class="acc-hdr" onclick="toggleAcc(this)">
      <div class="acc-title-area">
        <div class="acc-label">⚡ 3 Runde (Zero Pauză între exerciții)</div>
        <div class="acc-name" style="color:var(--orange);">Circuit Finisher (Metabolic)</div>
      </div>
      <div class="acc-icon">▼</div>
    </div>
    <div class="acc-content">
      <div class="acc-body">
        <div class="ex-list">
          <div class="ex-item">
            ...
            <div class="ex-sets">45 secunde</div>
          </div>
          <div class="ex-item">
            <div>
        ...
        <div style="text-align:center;font-size:11px;color:var(--orange);margin-top:10px;">(Pauză 30 secunde, repeti de 3 ori tot circuitul)</div>
      </div>
    </div>
  </div>
</div>
...
<div class="panel" id="tab-ziuaB">
  ...
  <div class="alert-box red">
    ...
    Varianta revizuită pentru protecția umărului și exerciții bilaterale noi (RDL cu ambele mâini).
  </div>
    ...
    <div class="acc-content">
      <div class="acc-body">
        <div class="ex-list">
          ...
          <div class="ex-item">
            <div>
              <div class="ex-name">2. RDL cu ambele mâini</div>
    ...
    <div class="acc-content">
      <div class="acc-body">
        <div class="ex-list">
          <div class="ex-item">
            <div>
              <div class="ex-name">1. Ramat cu o ganteră</div>
          ...
          <div class="ex-item">
            <div>
              <div class="ex-name">3. Extensii deasupra capului triceps</div>
          ...
          <div class="ex-item">
            <div>
              ...
              <div class="ex-cue">
                ...
                • <strong>Hammers Curls:</strong> 15 rep <a href="https://www.youtube.com/shorts/Z7gLnOCO89c" target="_blank" style="color:var(--red);">[Video]</a><br>
    ...
    <div class="acc-content">
      <div class="acc-body">
        <div class="ex-list">
          ...
          <div class="ex-item">
            <div>
              <div class="ex-name">2. Fandări în față</div>
...
pattern = re.compile(r'<!-- ==================== TAB 2: ZIUA A.*?<!-- ==================== TAB 6: MVE & PLATOU', re.DOTALL)
new_content = pattern.sub(all_tabs_html + "\n<!-- ==================== TAB 6: MVE & PLATOU", content)
...
if content == new_content:
    ...
    with open(file_path, 'w', encoding='utf-8') as f:
        f.write(new_content)
    print("SUCCESS MATCH AND REPLACE")
